...
//int video_serialPort(int fd, char* buf, char until) ;
...
int main(int argc, char *argv[]) 
{
   	...
   	while(1)
	{
		...
		if(buf[1] == '\n' && buf[0] == '0')      // if comunicación exitosa Grabar video
		{
		    send1 = '0' ; 
		    system("v4l2-ctl --set-fmt-video width=320,height=176,pixelformat=1") ;
	        system("./exe1 -m -c 31 -o > videoReporte.mjpeg") ;        	
    		//system("tar -cvzf _2server.tar.gz _2server") ;
		}
   	}
